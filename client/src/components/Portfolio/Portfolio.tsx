      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-3">
        ...
        <div className="relative overflow-hidden rounded-xl shadow-lg group">
          <img
            ...
            className="w-full h-[350px] object-cover transition-transform duration-500 md:group-hover:scale-110"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#4B4B4B]/90 via-black/80 to-transparent flex flex-col justify-center items-center px-8 text-white transform md:translate-y-full md:group-hover:translate-y-0 transition-all duration-500">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#4B4B4B] hover:bg-[#6B6B6B] text-white font-semibold text-[12px] py-2 px-4 rounded shadow"
            >
              Show <FaChevronRight />
            </a>
          </div>
        ...
        <div className="relative overflow-hidden rounded-xl shadow-lg group">
          <img
            ...
            className="w-full h-[350px] object-cover transition-transform duration-500 md:group-hover:scale-110"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#4B4B4B]/90 via-black/80 to-transparent text-white flex flex-col justify-center items-center p-8 transform md:translate-y-full md:group-hover:translate-y-0 transition-transform duration-500">
            <h4 className="text-xl md:text-2xl font-semibold mb-2">
              Projects Completed:
            </h4>
            <ul className="text-[12px] md:text-base space-y-2 mb-4">
        ...
        <div className="relative overflow-hidden rounded-xl shadow-lg group">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#4B4B4B]/90 via-black/80 to-transparent text-white flex flex-col justify-center items-center p-8 transform md:translate-y-full md:group-hover:translate-y-0 transition-transform duration-500">
            ...
            <ul className="text-[12px] md:text-base space-y-2">
              <li>
                <a
                  href="https://hilarygh.github.io/GO2COD_WD_01/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#6B6B6B]"
                >
